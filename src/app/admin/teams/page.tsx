        ...
        <main className="flex-1 overflow-auto p-4 md:p-6 lg:p-8 bg-gradient-to-br from-green-50/30 via-white to-green-50/30">
          ...
          <div className="mt-12 mb-8">
            <div className="max-w-2xl mx-auto text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 mb-4 shadow-sm">
              ...
              <p className="text-sm text-gray-500 max-w-md mx-auto">
                Manage teams, add members, and organize your intramural participants all in one place.
              </p>
